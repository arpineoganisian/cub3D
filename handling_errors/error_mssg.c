...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/11 22:24:27 by hwoodwri          #+#    #+#             */
/*   Updated: 2021/02/11 22:25:47 by hwoodwri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		error_mssg(int err, t_head *h)
{
	...
	err == 7 ?
		write(1, "Error: Please set valid floor/ceilling color\n", 45) : 0;
	...
	err == 11 ?
		write(1, "Error: Wrong file extention of the texture\n", 43) : 0;
